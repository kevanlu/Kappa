...
/** This is a slightly modified version of the ContrastAdjuster plugin found in ImageJ, written by Wayne Rasband
 *  Some methods were removed or modified to suit the purposes of this application. 
 * */
public class ContrastAdjuster extends PlugInFrame implements Runnable,
	...
	void setup() {
		ImagePlus imp = Kappa.displayedImageStack;
		if (imp!=null) {
			setup(imp);
			updatePlot();
			updateLabels(imp);
	...
	void doUpdate() {
		...
		Kappa.curves.updateIntensities();
		Kappa.updateDisplayed();
	}
	...
	public void windowActivated(WindowEvent e) {
		...
		if (IJ.isMacro()) {
			...
			ImagePlus imp2 = Kappa.displayedImageStack;
